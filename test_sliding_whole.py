        ...
        with torch.no_grad(): # no gradients to accelerate
            ...
            for k in range(warped_seg.shape[0]):
                ...
                if k == 0:
                    ...
                    rec_reg_12.append([img_ID, dice_csf, dice_gm, dice_wm, csf_ASD, gm_ASD, wm_ASD, csf_HD, gm_HD, wm_HD])
                elif k == 1:
                    print('24_reg', dice_csf, dice_gm, dice_wm, csf_ASD, gm_ASD, wm_ASD, csf_HD, gm_HD, wm_HD)
                    rec_reg_24.append([img_ID, dice_csf, dice_gm, dice_wm, csf_ASD, gm_ASD, wm_ASD, csf_HD, gm_HD, wm_HD])

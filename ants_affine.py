...
# basic configuration
data_root = '/public/bme/home/v-sunyh2/data/brain_reg_seg'
...
for fold in range(start_fold, end_fold + 1):
    ...
    for file_ID in file_list:
        ...
        mo_list = sorted(os.listdir(os.path.join(data_root, file_ID)))
        ...
        for mo in mo_list:
            ...
            if save_image:
                ...
                ants.image_write(warped_seg, os.path.join(data_root, file_ID, mov_list[0], 'warped_seg_to_{}_ori.nii.gz'.format(mo[0:2])))
                ants.image_write(warped_ori, os.path.join(data_root, file_ID, mov_list[0], 'warped_ori_to_{}_ori.nii.gz'.format(mo[0:2])))

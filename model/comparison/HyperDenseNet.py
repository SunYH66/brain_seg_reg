...
def convBlock(nin, nout, kernel_size=(3,3,3), batchNorm=False, layer=nn.Conv3d, bias=True, dropout_rate=0.0, dilation=(1,1,1)):
    if not batchNorm:
...
class HyperDenseNet(nn.Module):
    def __init__(self, in_channels=3, classes=4):
        ...
        self.fully_1 = nn.Conv3d(4050, 400, kernel_size=(1,1,1))
        self.fully_2 = nn.Conv3d(400, 200, kernel_size=(1,1,1))
        self.fully_3 = nn.Conv3d(200, 150, kernel_size=(1,1,1))
        self.final = nn.Conv3d(150, classes, kernel_size=(1,1,1))
